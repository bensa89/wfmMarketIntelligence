...
function CitedItemList({ items, bullet, hoverClass, max = 4, onSelectSignal }: CitedListProps) {
  ...
  return (
    <div className="grid grid-cols-3 gap-4 mt-4">
      <div className="bg-red-50 border border-red-100 rounded-xl p-4">
        ...
        <CitedItemList items={risks} bullet="text-red-500" hoverClass="hover:bg-red-100" onSelectSignal={onSelectSignal} />
      </div>

      <div className="bg-green-50 border border-green-100 rounded-xl p-4">
        <h4 className="text-[12px] font-semibold text-green-700 mb-2">Opportunities</h4>
        <CitedItemList items={opportunities} bullet="text-green-500" hoverClass="hover:bg-green-100" onSelectSignal={onSelectSignal} />
      </div>

      <div className="bg-amber-50 border border-amber-100 rounded-xl p-4">
        <h4 className="text-[12px] font-semibold text-amber-700 mb-2">Watchpoints</h4>
        <CitedItemList items={allWatchpoints} bullet="text-amber-500" hoverClass="hover:bg-amber-100" max={5} onSelectSignal={onSelectSignal} />
      </div>
    </div>
  );
}
