...
class ScheduleConfig(Base):
    ...
    crawl_day_of_week = Column(Integer, nullable=False, default=0)
    crawl_time = Column(String(5), nullable=False, default="06:00")
    ...
    digest_day_of_week = Column(Integer, nullable=False, default=1)
